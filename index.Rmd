...
library(metathis)
meta() %>%
  meta_name("github-repo" = "llrs/gahna_packages") %>% 
  meta_social(
    title = "Creating packages",
    description = paste(
    ...
    url = "https://gahna_packages.llrs.dev",
    image = "https://gahna_packages.llrs.dev/index_files/figure-html/title_slide_screenshot.png",
    image_alt = paste(
